...
void solve() {
  ...
  for(int msk = 0; msk < (1<<4); ++msk){
    ...
    // //Top row
    // for(int j = 1; j < n-1 and u > 0; ++j){
    //   grid[0][j] = 1;
    //   u--;
    // }

    // //Bottom row
    // for(int j = 1; j < n-1 and d > 0; ++j){
    //   grid[n-1][j] = 1;
    //   d--;
    // }

    // //Right column
    // for(int i = 1; i < n-1 and r > 0; ++i){
    //   grid[i][n-1] = 1;
    //   r--;
    // }

    // //Left column
    // for(int i = 1; i < n-1 and l > 0; ++i){
    //   grid[i][0] = 1;
    //   l--;
    // }
    ...
    //   return;
    // }
    if(u >= 0 and u <= n-2 and d >= 0 and d <= n-2 and r >= 0 and r <= n-2 and l >= 0 and l <= n-2){
      cout<<"YES\n";
      dbg(msk);
      return;
    }
