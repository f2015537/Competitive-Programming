...
void solve() {
  ...
  pl low = {INFL, INFL}; //this stores cheapest leftmost segment
  pl high = {-INFL, -INFL}; //this stores cheapest rightmost segment
  pl single = {-INFL, -INFL}; //this stores cheapest single longest segment
  ...
  rep(n){
    ...
    if(single.F == high.F - low.F){
      ans = min(ans, -single.S);
    }
